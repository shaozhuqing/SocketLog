...
slog('msg-log', 'log');   //一般日志
slog('msg-error', 'error'); //错误日志
slog('msg-info', 'info');  //信息日志
slog('msg-warn', 'warn');  //警告日志
slog('msg-trace', 'trace'); // 输入日志同时会打出调用栈
slog('msg-alert', 'alert'); //将日志以alert方式弹出
slog('msg-html', 'log', 'color:red;font-size:20px;');//自定义日志的样式，第三个参数为css样式
